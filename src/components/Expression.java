...
//		this.mc = new MathContext(mc.getPrecision(), roundingMode);
	 ...
	 * @return The expression, allows to chain methods.
	 */
	public Expression setVariable(String variable, Apfloat value) {
	 ...
	 * @return The expression, allows to chain methods.
	 */
	public Expression with(String variable, Apfloat value) {
	 ...
	 * @return The expression, allows to chain methods.
	 */
	public Expression and(String variable, Apfloat value) {
		return setVariable(variable, value);
	}
